...
idleproc_run(int arg1, void *arg2)
{
        ...
        /* create init proc */
        dbg(DBG_PRINT, "Idle Process created\n");
...
initproc_create(void)
{
        ...
        /*int temp_pid = _proc_getid();
        dbg(DBG_PRINT,"PID is %d",temp_pid);*/
        dbg(DBG_PRINT, "Init Process created\n");
