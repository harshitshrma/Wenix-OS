...
\begin{itemize}
    ...
    \item A separate threads library assignment followed by two of the Wenix assignments (\wlink{vfs}{VFS} and \wlink{s5fs}{S5FS}).
\end{itemize}
